...
const ProfessionalFormPage = () => {
  ...
  const uploadImage = async (file: File): Promise<string> => {
    // Esta es una simulación simple para fines de demostración
    // En un entorno real, se crearía un FormData y se enviaría al servidor
    setUploadingImage(true);
    
    return new Promise((resolve) => {
      setTimeout(() => {
        // En un caso real, el servidor devolvería la URL de la imagen subida
